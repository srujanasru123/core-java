...
public static void main(String[] args){
				...
				System.out.println(value.startsWith("V"));
				...
				System.out.println(value.equalsIgnoreCase("Vijayanagara-banglore"));

				System.out.println("-------------------");

				System.out.println(value.equals("Vijaynagara-Banglore"));
